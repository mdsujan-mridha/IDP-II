...
const AtoZHeath = () => {
    return (
        <div className='container relative'>
            <div className=" bg-orange-700 h-60 w-72 absolute -right-10 -bottom-20 blur-3xl rounded-full opacity-40 z-10"></div>
            <div className='mt-24'>
                <h1
                    data-aos="fade-up"
                    data-aos-duration="2000"
                    className='text-6xl font-bold text-center pb-10'> <span className=' text-orange-500'> Your health </span> A to Z  </h1>
                <p
                    data-aos="fade-up"
                    data-aos-duration="1500"
                    className='text-center font-bold text-xl leading-8'> Easy–to–understand health information to help you be ready for your appointment. Learn what you need to know about symptoms, diagnosis, and treatment options to discuss with your doctor. From major surgery to routine procedures, find out what to expect and how to prepare for a successful outcome. </p>
                <div
                    data-aos="fade-up"
                    data-aos-duration="2000"
                    className='w-full bg-secondary mt-24 rounded-lg p-5 flex flex-col items-center justify-center shadow-2xl'>
                ...
                <div className='flex h-auto pb-10 mt-10 w-full gap-5'>
                    ...
                    <div
                        data-aos="fade-up"
                        data-aos-duration="2000"
                        className='w-1/2 p-5 rounded-md shadow-2xl' style={{ backgroundColor: '#583fe6' }}>
                    ...
                    <div
                        data-aos="fade-up"
                        data-aos-duration="2000"
                        className='w-1/2 flex flex-col items-center justify-center p-3 rounded-md shadow-2xl' style={{ backgroundColor: '#f9ab40' }}>
